(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='index.php' class='logo-mobile-menu'><img src='img/logo/logo-b.png' width='13%'><img src='img/logo/main-logo 1.png' width='30%'></a>" });
